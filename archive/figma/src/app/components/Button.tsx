...
export function Button({
  ...
  const variantStyles = {
    ...
    secondary: "bg-white dark:bg-neutral-800 text-foreground border-2 border-gray-200 dark:border-neutral-700 shadow-xl shadow-black/10 hover:shadow-2xl hover:scale-[1.02] hover:bg-gray-50 dark:hover:bg-neutral-700",
  ...
  const sizeStyles = {
    ...
    md: "px-6 py-3.5 lg:px-8 lg:py-4 lg:text-lg",
