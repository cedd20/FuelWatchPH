    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-neutral-950 dark:to-neutral-900 pb-20 lg:pb-8">
      ...
      <div className="lg:hidden mx-4 -mt-4 bg-white dark:bg-neutral-900 backdrop-blur-2xl rounded-2xl p-6 border-2 border-emerald-400/30 dark:border-emerald-500/30 shadow-2xl shadow-emerald-500/10 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 bg-gradient-to-br from-emerald-100 to-teal-100 dark:from-emerald-950/50 dark:to-teal-950/50 rounded-xl flex items-center justify-center shadow-lg">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                {mockStation.prices.map((fuel, index) => (
                  <div
                    key={index}
                    className="bg-white dark:bg-neutral-900 backdrop-blur-2xl rounded-2xl p-6 border-2 border-gray-200 dark:border-neutral-700 shadow-2xl shadow-black/10 hover:shadow-2xl hover:border-emerald-400/50 hover:scale-[1.02] transition-all"
                  >
                    <div className="mb-4">
            ...
            <div className="lg:sticky lg:top-6 space-y-6">
              ...
              <div className="bg-white dark:bg-neutral-900 backdrop-blur-2xl rounded-2xl p-6 border-2 border-emerald-400/30 dark:border-emerald-500/30 shadow-2xl shadow-emerald-500/10 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-emerald-100 to-teal-100 dark:from-emerald-950/50 dark:to-teal-950/50 rounded-xl flex items-center justify-center shadow-lg">
                      <ShieldCheck className="w-6 h-6 text-emerald-600 dark:text-emerald-500" strokeWidth={2.5} />
                    </div>
                    <div className="px-3 py-1.5 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-full text-xs font-bold shadow-lg shadow-teal-500/30">
                      Trusted
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full px-6 py-4 bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 text-white rounded-2xl font-bold text-base shadow-2xl shadow-emerald-500/50 hover:shadow-emerald-500/70 hover:scale-[1.02] transition-all border-2 border-emerald-400/30"
                >
                  Update Fuel Price
                </button>
                <button
                  onClick={handleGetDirections}
                  className="w-full px-5 py-3.5 bg-white dark:bg-neutral-800 border-2 border-gray-200 dark:border-neutral-700 rounded-2xl font-bold text-sm text-foreground shadow-xl shadow-black/10 hover:shadow-2xl hover:border-emerald-400/50 hover:scale-[1.02] transition-all flex items-center justify-center gap-2"
                >
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs text-muted-foreground/70 font-semibold">per liter</div>
                </div>
              </div>
            </div>
          ))}
      ...
      <div className="lg:hidden fixed bottom-16 left-0 right-0 bg-white dark:bg-neutral-900 border-t-2 border-gray-200 dark:border-neutral-700 p-5 shadow-2xl shadow-black/20">
        <div className="max-w-lg mx-auto space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              onClick={handleGetDirections}
              className="px-5 py-3.5 bg-white dark:bg-neutral-800 border-2 border-gray-200 dark:border-neutral-700 rounded-2xl font-bold text-sm text-foreground shadow-xl shadow-black/10 hover:shadow-2xl hover:border-emerald-400/50 hover:scale-[1.02] transition-all flex items-center justify-center gap-2"
            >
              <Navigation className="w-4 h-4" strokeWidth={2.5} />
              Directions
            </button>
