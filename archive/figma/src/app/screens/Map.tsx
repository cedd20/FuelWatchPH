...
import { BrandLogoPin } from "../components/BrandLogoPin";
import { MapPriceLegend } from "../components/MapPriceLegend";
...
export function Map() {
  ...
  const getStationPrice = (station: typeof mockStations[0]) => {
