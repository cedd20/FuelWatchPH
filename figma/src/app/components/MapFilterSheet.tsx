...
export function MapFilterSheet({ isOpen, onClose, onApply }: MapFilterSheetProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end lg:items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-card w-full max-w-lg max-h-[90vh] lg:max-h-[85vh] rounded-t-2xl lg:rounded-2xl overflow-hidden flex flex-col shadow-2xl">
        ...
        {/* Footer */}
        <div className="p-4 lg:p-6 border-t-2 border-gray-200 dark:border-neutral-700 flex gap-3 lg:gap-4 bg-white dark:bg-neutral-900">
          <button
            onClick={handleReset}
