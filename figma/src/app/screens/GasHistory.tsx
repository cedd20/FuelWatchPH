...
import { PriceMovementBadge } from "../components/PriceMovementBadge";
...
// Fuel type mapping
const fuelTypeMap: Record<string, keyof typeof chartData[0]> = {
  "Diesel": "diesel",
          ...
          <div className="lg:grid lg:grid-cols-3 lg:gap-8">
            ...
            <svg className="w-full h-full" viewBox="0 0 380 280">
              {(() => {
                ...
                const prices = chartData.map(d => d[fuelKey] as number);
                  ...
                  <g>
                    ...
                    <polyline
                      points={chartData.map((d, i) => {
                        const price = d[fuelKey] as number;
                ...
                <Accordion.Content className="data-[state=open]:animate-slideDown data-[state=closed]:animate-slideUp overflow-hidden">
                  <div className="px-6 pb-6 pt-4 border-t border-white/20 dark:border-neutral-700/30">
                    ...
                    <div className="space-y-3 lg:grid lg:grid-cols-2 lg:gap-4 lg:space-y-0">
                      {weeklyBrandData[week.week as keyof typeof weeklyBrandData]?.map((brand, brandIndex) => (
                            ...
                            <details className="mb-3">
                              ...
                              <div className="grid grid-cols-2 lg:grid-cols-1 gap-x-4 gap-y-3 mt-4">
                                {Object.entries(brand.prices).map(([key, value]) => {
                                  ...
                                  const getColorClass = (fuelName: string) => {
                                    if (fuelName.toLowerCase().includes('diesel')) return 'text-warning';
